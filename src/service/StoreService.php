...
class StoreService
{
    ...
    {// produto|  codigoItem
        ...
        if($produto){
            ...
            {
                $pastel = new stdClass;
                $pastel->idCardapioPastel = $produto->idCardapioPastel;
                $pastel->saborDoPastel = $produto->saborDoPastel;
                $pastel->ingrediente = $produto->ingrediente;
                $pastel->count = 1;

                array_push($carrinho, [ $pastel ]);
                $_SESSION["cart"][$cart["produto"]] = $carrinho;
