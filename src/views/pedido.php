...
<div class="container">
  ...
  <div class="row justify-content-center">
        ...
        <div class="col-sm-9">
          ...
          <?php $this->insert('fragmentos/pedido/bairros.entrega.part', ['localizacao' => $localizacao]) ?>

          <!-- exibe o icone de carrinho além dos produtos adicionados -->
          <?php $this->insert('fragmentos/pedido/carrinho.part', [
            'cardapios' => $cardapios, 'bebidas' => $bebidas, 'message' => $message
          ]) ?>

        <!-- Tabela de Pasteis -->
        <?php $this->insert('fragmentos/pedido/pastel.part', ['cardapios' => $cardapios, 'bebidas' => $bebidas])  ?>

        <!-- Tabela de bebidas -->
        <?php $this->insert('fragmentos/pedido/bebida.part', ['cardapios' => $cardapios, 'bebidas' => $bebidas])  ?>

        <!-- formulario dados do cliente -->
        <?php $this->insert('fragmentos/pedido/dados.cliente.part', [ 'user' => isset($user) || !is_null($user) ? $user : null ]) ?>
    </div>
  </div>
