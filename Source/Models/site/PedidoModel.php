...
class PedidoModel extends DataLayer
{
   ...
   * @return PedidoModel
   */
  public function createNew(array $data): PedidoModel
  {
    ...
    $this->valorTotal     = LojaService::calc_total();
    ...
    (new PedidoPastelModel)->addPastel($this->idPedido);
   ...
   * @return PedidoModel
   * */
  public function buscarPedidoDetalhado(): PedidoModel
  {
