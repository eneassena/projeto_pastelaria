  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?= url('area-restrita') ?>" class="brand-link">
        <img src="<?= url('theme/assets/image/logo.png') ?>"
        alt="Pastelaria Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item menu-open">
              ...
              <?php if(isset($_SESSION['user_superuser'])):?>
                  <li class="nav-item">
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; 2021 <a href="<?= url('area-restrita') ?>" target="_blank" >Pastelariadogaucho.com</a>.</strong> Todos os
      direitos
      preservados.
    </footer>
  </div>
