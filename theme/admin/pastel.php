   ...
   <div class="col-md-11 mt-5">
     ...
     <div class="row justify-content-center" id="form_pastel" style="display:none">
       ...
       <div class="col-sm-12">
         ...
         <form class="pt-3" action="<?php echo url('area-restrita/pastel-store') ?>" method="POST" id="form_pedido_cliente_on">
           <div class="form-row">
           ...
           <div class="form-row">
             <div class="form-group col-sm-12 col-md-12">
               ...
               <input type="text" class="form-control positive money" name="valorUnitario" id="sValor" placeholder="0,00" required maxlength="5" />
             </div>
