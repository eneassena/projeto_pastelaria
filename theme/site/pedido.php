...
<div class="container">
    ...
    <div class="row justify-content-end">
        <span style="text-shadow: 3px 3px 10px rgba(0,0,0,0.7)" class="mx-3 text-muted">Aberta de Segunda a Domingo,
            exceto Quarta e Quinta.</span>
    </div>
    <hr class="border">
    ...
    <div class="row justify-content-center">
        ...
        'cardapios' => $cardapios, 'bebidas' => $bebidas, 'message' => $message
            ...
            <!-- Tabela de Pasteis -->
            <?php $this->insert('site/fragmentos/pedido/pastel.part', ['cardapios' => $cardapios, 'bebidas' => $bebidas])  ?>

            <!-- Tabela de bebidas -->
            <?php $this->insert('site/fragmentos/pedido/bebida.part', ['cardapios' => $cardapios, 'bebidas' => $bebidas])  ?>

            <!-- formulario dados do cliente -->
            <?php $this->insert('site/fragmentos/pedido/dados.cliente.part', ['user' => isset($user) || !is_null($user) ? $user : null]) ?>
        </div>
    </div>
